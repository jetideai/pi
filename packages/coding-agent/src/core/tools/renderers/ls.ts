...
import { getTextOutput, renderToolPath, SectionedToolCallHeader, str } from "../render-utils.ts";
...
> = {
	...
	renderCall(args, theme, context) {
		...
		header.setSectionedText(formatLsCall(args as any, theme, context.cwd), context.sectioned);
		return header;
	},
